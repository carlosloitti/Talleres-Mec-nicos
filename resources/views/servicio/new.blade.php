        ...
        <form method="POST" action="{{route('servicios.store')}}">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="id" aria-describedby="idHelp" name="id"
                    disabled="disabled">
              <div id="idHelp" class="form-text">Servicio Code</div>
            </div>
            <div class="mb-3">
              <label for="name" class="form-label">Servicio Fecha de servicio</label>
              <input type="text" class="form-control" id="id" aria-describedby="nameHelp" name="fecha_servicio"
             placeholder="Servicio Fecha de servicio" >             
            </div>

            <div class="mb-3">
                <label for="name" class="form-label">Servicio descripcion</label>
                <input type="text" class="form-control" id="id" aria-describedby="nameHelp" name="descripcion"
               placeholder="Servicio descripcion" >             
              </div>

              <div class="mb-3">
                <label for="name" class="form-label">servicio costo</label>
                <input type="text" class="form-control" id="id" aria-describedby="nameHelp" name="costo"
               placeholder="servicio costo" >             
              </div>
